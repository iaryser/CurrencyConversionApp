...
public class CurrencyConversionClient {
    ...
    public ConversionResponse makeConversionRequest(String fromCurrency, String toCurrency, int amount) {
        if(amount > 0) {
            ...
            try {
                ...
                ConversionResponse responseObject = gson.fromJson(response.body(), ConversionResponse.class);
